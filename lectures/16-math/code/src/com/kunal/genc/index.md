...
<head>
    ...
    <title>16-math\code\src\com\kunal</title>
    <style>
        body{
            padding: 0px;
            margin: 0px;
...
<div id="grid-con">
   <div class="col mb-4">
                    <div><a href="bitwise"><img class="rounded img-fluid shadow w-100 fit-cover" src="./../../../../../genstatic/folder.png" style="height: 250px;"></a>
                        <div class="py-4"><span class="badge bg-primary mb-2">Website</span>
                            <h4 class="fw-bold">bitwise</h4>
                    ...
                    <div><a href="maths"><img class="rounded img-fluid shadow w-100 fit-cover" src="./../../../../../genstatic/folder.png" style="height: 250px;"></a>
                        <div class="py-4"><span class="badge bg-primary mb-2">Website</span>
