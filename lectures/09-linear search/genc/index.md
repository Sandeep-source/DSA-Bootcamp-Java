...
<div id="grid-con">
   <div class="col mb-4">
                    ...
                    <div><a href="Handwritten%20notes%20on%20Linear%20search.pdf"><img class="rounded img-fluid shadow w-100 fit-cover" src="./../genstatic/file.png" style="height: 250px;"></a>
                        <div class="py-4"><span class="badge bg-primary mb-2">Website</span>
                            <h4 class="fw-bold">Handwritten notes on Linear search.pdf</h4>
                            <p class="text-muted">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                        </div>
                    </div>
</div><div class="col mb-4">
                    <div><a href="Linear%20Search.pdf"><img class="rounded img-fluid shadow w-100 fit-cover" src="./../genstatic/file.png" style="height: 250px;"></a>
                        <div class="py-4"><span class="badge bg-primary mb-2">Website</span>
                            <h4 class="fw-bold">Linear Search.pdf</h4>
                            <p class="text-muted">Nullam id dolor id nibh ultricies vehicula ut id elit. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus.</p>
                        </div>
                    </div>
</div><div class="col mb-4">
