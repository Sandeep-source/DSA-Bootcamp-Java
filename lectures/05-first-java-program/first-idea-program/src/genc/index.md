...
<head>
    ...
    <title>05-first-java-program\first-idea-program\src</title>
    <style>
        body{
            padding: 0px;
            margin: 0px;
...
<div id="grid-con">
   <div class="col mb-4">
                    <div><a href="com"><img class="rounded img-fluid shadow w-100 fit-cover" src="./../../../genstatic/folder.png" style="height: 250px;"></a>
                        <div class="py-4"><span class="badge bg-primary mb-2">Website</span>
                            <h4 class="fw-bold">com</h4>
